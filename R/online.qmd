...
Compare the resutls of these two models are nearly identical.  
...
In this dataset, we can estiamte the extra-parmaters (the between-study sd in varaince and also the between-study correlaiton) and now visualize the results:

```{r}
# getting plots
plots_fit_mr1p <- list(
  visualize_fixed_effects(fit_mr1b),
  visualize_random_effects(fit_mr1b),
  visualize_correlations(fit_mr1b)
)

plots_fit_mr1b[[1]] / plots_fit_mr1b[[2]] / plots_fit_mr1b[[3]]
```
